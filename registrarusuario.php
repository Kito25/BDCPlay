...
config_set($config_data, "Detalles del usuario $Correo", "Correo", $Correo);
config_set($config_data, "Detalles del usuario $Correo", "Contrasenia", $Contrasenia);
// Los guarda
config_write($config_data, $config_file);


echo "<br>";
echo "<div align='center'><h3>Exito el usuario $Correo, se ha registrado!</h3>";
echo "<br>";
